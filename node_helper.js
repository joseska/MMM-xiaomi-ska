...
module.exports = NodeHelper.create({
  ...
  socketNotificationReceived: function(notification, payload) {
    if (notification === 'START') {
      ...
      if (payload.gatewayToken == null || payload.gatewayToken === "") {
        var device = miio.device({ address: payload.gatewayIP})
        .then(    
          function(gateway) {
        ...
        var device = miio.device({ address: payload.gatewayIP, token: payload.gatewayToken })
          .then(    
            function(gateway) {
              self.getDevices(gateway)
          })
  ...
  getDevices: function(gateway) {
    ...
    this.sendSocketNotification('SENSORS', sensors);
  },
